...
model_zoo   = [LorenzModel(rho=rho) for rho in np.arange(28,80,40)]
lorenz_data = LorenzPeriodicRhoData(true_model, model_zoo, batch_size = 64, num_train = 10000, num_val = 1600)
